...
Creating copies of a model instance on the fly with explicit declaration on how the instance should be cloned with support for limiting fields or related objects copied and unique field detection. 
