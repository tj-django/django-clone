    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applied_drivers', models.ManyToManyField(blank=True, related_name='driver_applications', to='sample_driver.Driver', verbose_name='Driver applications')),
                ('chosen_drivers', models.ManyToManyField(blank=True, to='sample_driver.Driver', verbose_name='Chosen drivers')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sample_company.CompanyDepot', verbose_name='Company')),
                ('contract', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assignment_contracts', to='sample_assignment.Contract', verbose_name='Choose contract')),
            ],
            options={
